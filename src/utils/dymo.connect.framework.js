...
(goog.debug.LogManager.getLoggers = function () {
  ...
  (goog.net.XhrIo.protectEntryPoints = function (e) {
    goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_ = e.protectEntryPoint(
...
(dymo.label.framework.Label.prototype._getObjectElements = function (e) {
  ...
  (dymo.label.framework.Label.prototype._getAddressObjectElementByIndex = function (
    e
  ) {
  ...
  (dymo.label.framework.Label.prototype._verifyAddressBarcodePosition = function (
    e
  ) {
    if (
  ...
  (dymo.label.framework.Label.prototype._getDateTimeCounterObjectText = function (
    e
  ) {
    var o = "";
    if (this.isDCDLabel()) {
  ...
  (dymo.label.framework.Label.prototype._getStyledTextLineAttributes = function (
    e
  ) {
    for (
      var o = new Array(),
  ...
  (dymo.label.framework.Label.prototype._setDateTimeCounterObjectText = function (
    e,
    o
  ) {
    if (this.isDCDLabel()) {
  ...
  (goog.net.IframeIo.prototype.logger_ = goog.log.getLogger(
    "goog.net.IframeIo"
  )),
...
(dymo.label.framework.init = function (e) {
  ...
  (dymo.label.framework.PrintJob.prototype.getStatusForNetworkPrinter = function (
    t
  ) {
    ...
    new goog.net.Jsonp(
      ...
      function () {
        var e = new dymo.label.framework.PrintJobStatusInfo(
          ...
          g,
          dymo.label.framework.PrintJobStatus.ProcessingError,
          'Error processing getPrintJobStatus(): Unable to contact "' + o + '"'
        );
        t(e);
      }
    );
